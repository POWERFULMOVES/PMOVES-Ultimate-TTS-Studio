# PMOVES.AI Integration Guide for Ultimate TTS Studio

## Integration Complete

The PMOVES.AI integration template has been applied to Ultimate TTS Studio.
...
async def startup():
    await announce_service(
        ...
        url=f"http://ultimate-tts-studio:7861",
        port=7861,
        tier="media"
    )
```
...
docker compose exec ultimate-tts-studio env | grep PMOVES
...
- **Tier:** media
- **Port:** 7861
- **Health Check:** http://localhost:7861/healthz
- **NATS Enabled:** True
- **GPU Enabled:** False
